...
from config import PROJECT_SEED, images_folder, annotations_folder, \
                   sheets_folder, models_folder
from utils.models import AdaptedUNet
from utils.training_utils import CombinedLoss
from utils.dataset_utils import SupervisedTrainingDataset, seed_worker
from utils.visualization_utils import rgb_image_viewer, image_viewer
...
configuration = {
    ...
    "dataset_filename": 'supervised_remaining.xlsx',
    "seed": PROJECT_SEED,
    "model_name": "AdaptedUNet",
    "compile_model": False,
    "checkpoint_path": None, #Path(models_folder / 'Adapted_U-Net_2023-05-03_22h13m09s' / 'checkpoint_I30000.tar').as_posix(),
