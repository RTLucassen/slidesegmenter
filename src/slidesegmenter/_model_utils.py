...
"""
Implementation of network architecture in Pytorch.
The architecture is similar to a U-Net, but with padded convolutions,
a downsample and upsample factor of four for all but the first level,
instance normalization, and two decoder branches
"""
